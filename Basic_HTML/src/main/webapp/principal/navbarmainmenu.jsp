			...
			<div class="main-menu-content">
				<ul>
					<li class="more-details"><a href="user-profile.html"><i
							...
							<a href="<%=request.getContextPath() %>/ServletLogin?action=logout"><i class="ti-layout-sidebar-left"></i>Logout</a></li>
				</ul>
			</div>
		</div>
		...
		<ul class="pcoded-item pcoded-left-item">
			...
			<li class="pcoded-hasmenu">
				...
				<ul class="pcoded-submenu">
					<li class=" ">
						<a href="<%=request.getContextPath() %>/principal/user-registration.jsp" class="waves-effect waves-dark">
