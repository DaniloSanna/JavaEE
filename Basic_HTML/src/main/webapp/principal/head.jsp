...
<meta name="description" content="JSP Project" />
<meta name="keywords" content="java, javaweb, jsp, springboot" />
<meta name="author" content="Danilo Sanna" />
<!-- Favicon icon -->
<link rel="icon" href="<%= request.getContextPath() %>/assets/images/favicon.ico" type="image/x-icon">
<!-- Google font-->
<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto:400,500">
<!-- waves.css -->
<link rel="stylesheet" type="text/css" href="<%= request.getContextPath() %>/assets/pages/waves/css/waves.min.css" media="all">
<!-- Required Fremwork -->
